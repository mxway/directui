...
{
	if( m_pHeader != NULL ) { // ����header����Ԫ��x����,��Ϊ��Щlistitem��setpos��Ҫ�õ�(��ʱ�޸�)
...
const CDuiString & CListUI::GetItemBkImage() const
{
...
const CDuiString & CListUI::GetSelectedItemImage() const
{
...
const CDuiString & CListUI::GetHotItemImage() const
{
...
const CDuiString & CListUI::GetDisabledItemImage() const
{
...
void CListBodyUI::SetPos(RECT rc, bool bNeedInvalidate)
{
    ...
    if( m_pOwner ) {
        ...
        if( pHeader != NULL && pHeader->GetCount() > 0 ) {
            cxNeeded = MAX((LONG)0, pHeader->EstimateSize(CDuiSize(rc.right - rc.left, rc.bottom - rc.top)).cx);
        }
    }
...
const CDuiString & CListHeaderItemUI::GetNormalImage() const
{
...
const CDuiString & CListHeaderItemUI::GetHotImage() const
{
...
const CDuiString & CListHeaderItemUI::GetPushedImage() const
{
...
const CDuiString & CListHeaderItemUI::GetFocusedImage() const
{
...
const CDuiString & CListHeaderItemUI::GetSepImage() const
{
...
void CListLabelElementUI::SetText(const CDuiString &pstrText)
{
    m_bNeedEstimateSize = true;
