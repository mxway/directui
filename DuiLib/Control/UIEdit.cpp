...
namespace DuiLib
{
	...
	void CEditUI::SetText(const CDuiString &pstrText)
	{
		m_sText = pstrText;
	...
	const CDuiString & CEditUI::GetNormalImage()
	{
	...
	const CDuiString & CEditUI::GetHotImage()
	{
	...
	const CDuiString & CEditUI::GetFocusedImage()
	{
	...
	const CDuiString & CEditUI::GetDisabledImage()
	{
