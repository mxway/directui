...
public:
    ...
    const CDuiString & GetItemBkImage() const;
    ...
    const CDuiString & GetSelectedItemImage() const;
    void SetSelectedItemImage(LPCTSTR pStrImage);
    DWORD GetHotItemTextColor() const;
    void SetHotItemTextColor(DWORD dwTextColor);
    DWORD GetHotItemBkColor() const;
    void SetHotItemBkColor(DWORD dwBkColor);
    const CDuiString & GetHotItemImage() const;
    void SetHotItemImage(LPCTSTR pStrImage);
    DWORD GetDisabledItemTextColor() const;
    void SetDisabledItemTextColor(DWORD dwTextColor);
    DWORD GetDisabledItemBkColor() const;
    void SetDisabledItemBkColor(DWORD dwBkColor);
    const CDuiString & GetDisabledItemImage() const;
...
public:
    ...
    const CDuiString & GetNormalImage() const;
    void SetNormalImage(LPCTSTR pStrImage);
    const CDuiString & GetHotImage() const;
    void SetHotImage(LPCTSTR pStrImage);
    const CDuiString & GetPushedImage() const;
    void SetPushedImage(LPCTSTR pStrImage);
    const CDuiString & GetFocusedImage() const;
    void SetFocusedImage(LPCTSTR pStrImage);
    const CDuiString & GetSepImage() const;
...
public:
    ...
    void SetText(const CDuiString &pstrText);
