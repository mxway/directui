...
namespace DuiLib
{
	...
	const CDuiString & COptionUI::GetGroup() const
	{
		return m_sGroupName;
	}

	void COptionUI::SetGroup(const CDuiString &pStrGroupName)
	{
	...
	const CDuiString & COptionUI::GetSelectedImage()
	{
	...
	const CDuiString & COptionUI::GetSelectedHotImage()
	{
