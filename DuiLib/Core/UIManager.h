...
public:
	...
	const CDuiString & GetName() const;
	...
	const CDuiString & GetLayeredImage();
    ...
    static void SetResourcePath(const CDuiString &pStrPath);
    ...
    void SetDefaultFont(const CDuiString &pStrFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bShared = false);
    DWORD GetCustomFontCount(bool bShared = false) const;
    HFONT AddFont(int id, const CDuiString &pStrFontName, int nSize, bool bBold, bool bUnderline, bool bItalic, bool bShared = false);
    HFONT GetFont(int id);
    HFONT GetFont(const CDuiString &pStrFontName, int nSize, bool bBold, bool bUnderline, bool bItalic);
    ...
    const TImageInfo* GetImage(const CDuiString &bitmap);
    const TImageInfo* GetImageEx(const CDuiString &bitmap, const CDuiString &type="", DWORD mask = 0, bool bUseHSL = false);
    const TImageInfo* AddImage(const CDuiString &bitmap, const CDuiString &type, DWORD mask = 0, bool bUseHSL = false, bool bShared = false);
    ...
    CControlUI* FindControl(const CDuiString &pstrName) const;
