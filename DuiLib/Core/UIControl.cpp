...
void CControlUI::SetText(const CDuiString &pstrText)
{
...
const CDuiString & CControlUI::GetBkImage()
{
...
void CControlUI::SetAttributeList(const CDuiString &attributeList)
{
    CDuiString sItem;
    CDuiString sValue;
    const char *pstrList = attributeList.GetData();
    while( *pstrList != _T('\0') ) {
        sItem.Empty();
        sValue.Empty();
