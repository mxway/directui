...
bool CNotifyPump::AddVirtualWnd(const CDuiString &strName, CNotifyPump* pObject)
{
...
HWND CWindowWnd::Create(HWND hwndParent, LPCTSTR pstrName, DWORD dwStyle, DWORD dwExStyle, int x, int y, int cx, int cy, HMENU hMenu)
{
    ...
    wchar_t *windowClassName = (wchar_t *)Utf8ToUtf16(GetWindowClassName());
    wchar_t *unicodeWindowName = (wchar_t *)Utf8ToUtf16(pstrName);

    m_hWnd = ::CreateWindowExW(dwExStyle,windowClassName, unicodeWindowName, dwStyle, x, y, cx, cy, hwndParent, hMenu, CPaintManagerUI::GetInstance(), this);
    delete []windowClassName;
    delete []unicodeWindowName;
    ASSERT(m_hWnd!=NULL);
    return m_hWnd;
}
