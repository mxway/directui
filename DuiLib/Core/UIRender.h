...
public:
    ...
    static void DrawText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, const CDuiString &pstrText, \
        DWORD dwTextColor, int iFont, UINT uStyle);
    static void DrawHtmlText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, const CDuiString &pstrText,
                             DWORD dwTextColor, RECT* prcLinks, CDuiString* sLinks, int& nLinkRects, int iDefaultFont, UINT uStyle);
